...
IRCSERVER, IRCPORT = "irc.chatspike.net", 6667
...
FEEDBACK_FROM = "dave@uesp.net"

# OPTION: FEEDBACK_TO:
#         E-mail address that feedback will be sent to.
FEEDBACK_TO = "dave@uesp.net"
